		...
		function LogPanel(props) {
			...
			return react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
				...
				entries.length ? react_jsx_runtime.jsxs("div", { children: [
					react_jsx_runtime.jsx("div", { className: "npx-log-list", children: entries.map(function (it) {
						return react_jsx_runtime.jsx(LogItem, { t: t, it: it, expanded: expanded, onToggle: function (id) { setExpanded(expanded === id ? null : id); } });
					}) }),
					entries.length >= limit && limit < 500 ? react_jsx_runtime.jsx("div", { className: "npx-log-more", children: react_jsx_runtime.jsx(Button, { variant: "outline", onClick: function () { setLimit(500); }, children: t("logMore") }) }) : null,
