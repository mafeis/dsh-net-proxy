...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var en = {
			...
			followPending: "Effective now (following system): ",
		...
		function NetProxySection(props) {
			...
			return react_jsx_runtime.jsx("div", { className: "npx-root", children: [
				...
				tab === "log" ? react_jsx_runtime.jsx(LogPanel, { t: t }) : tab === "charts" ? react_jsx_runtime.jsx(ChartPanel, { t: t }) : react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
					...
					// 生效与否只用红/绿横幅表达：绿=总开关开、按此地址转发；红=总开关关、未转发。文案统一。
					following ? react_jsx_runtime.jsx("div", { className: on ? "npx-alert ok" : "npx-alert err", style: { fontWeight: 600 }, children: t("followEffective") + " " + sysInfo.proxy }) : null,
