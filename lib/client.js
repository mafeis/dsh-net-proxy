...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var css =
			...
			".npx-json-pre{margin:8px 0 0;padding:8px;border-radius:6px;background:var(--dsw-alias-bg-layer-2,#1a1e26);font-family:var(--dsw-font-mono,monospace);font-size:11px;line-height:1.5;color:var(--dsw-alias-label-secondary);white-space:pre-wrap;word-break:break-all}",
			...
			".npx-json{font-family:var(--dsw-font-mono,monospace);font-size:11.5px;line-height:1.6;color:var(--dsw-alias-label-secondary);padding:10px 12px;border-radius:8px;background:var(--dsw-alias-bg-layer-2,#1a1e26);border:1px solid var(--dsw-alias-border-l2,#222834);user-select:text}",
