	...
	factory: (require) => {
		...
		function NetProxySection(props) {
			...
			function testNow() {
				...
				fetch(API, { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify({ action: "probe", proxy: p }) })
					.then(function (r) { return r.json(); })
			...
			return react_jsx_runtime.jsx("div", { className: "npx-root", children: [
				...
				react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
					...
					probe.res ? react_jsx_runtime.jsx("div", { className: "npx-probe", children: [
						react_jsx_runtime.jsx("div", { className: "npx-alert " + (probe.res.ok ? "ok" : "err"), children: probe.res.ok ? t("testOk") : (t("testFail") + (probe.res.error ? "：" + probe.res.error : "")) }),
						probe.res.ok ? react_jsx_runtime.jsx("div", { className: "npx-probe-stats", children: [
							react_jsx_runtime.jsx("div", { className: "npx-probe-stat", children: [react_jsx_runtime.jsx("span", { children: t("rttProxy") }), react_jsx_runtime.jsx("b", { children: (probe.res.connectMs >= 0 ? probe.res.connectMs : "—") + " " + t("statMs") })] }),
							react_jsx_runtime.jsx("div", { className: "npx-probe-stat", children: [react_jsx_runtime.jsx("span", { children: t("rttTotal") }), react_jsx_runtime.jsx("b", { children: (probe.res.totalMs >= 0 ? probe.res.totalMs : "—") + " " + t("statMs") })] }),
							react_jsx_runtime.jsx("div", { className: "npx-probe-stat", children: [react_jsx_runtime.jsx("span", { children: t("httpStatus") }), react_jsx_runtime.jsx("b", { children: probe.res.httpStatus })] }),
						] }) : null,
					] }) : null,
				] }),
			] });
