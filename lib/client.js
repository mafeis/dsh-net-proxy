...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var css =
			...
			".npx-log-empty{padding:24px;text-align:center;font-size:12px;color:var(--dsw-alias-label-tertiary)}"].join("");
		...
		function NetProxySection(props) {
			...
			return react_jsx_runtime.jsx("div", { className: "npx-root", children: [
				...
				tab === "log" ? react_jsx_runtime.jsx(LogPanel, { t: t }) : react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
