...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			followPending: "未生效（总开关已关闭）：",
			followPendingHint: "开启「启用代理」后将按此地址转发。",
		...
		var en = {
			...
			followPending: "Not effective (master switch off): ",
			followPendingHint: "Turn on the master switch to forward via this address.",
		...
		function NetProxySection(props) {
			...
			return react_jsx_runtime.jsx("div", { className: "npx-root", children: [
				...
				tab === "log" ? react_jsx_runtime.jsx(LogPanel, { t: t }) : tab === "charts" ? react_jsx_runtime.jsx(ChartPanel, { t: t }) : react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
					...
					following ? react_jsx_runtime.jsxs("div", { className: on ? "npx-alert ok" : "npx-alert err", children: [
						react_jsx_runtime.jsx("div", { style: { fontWeight: 600 }, children: (on ? t("followEffective") : t("followPending")) + " " + sysInfo.proxy }),
						!on ? react_jsx_runtime.jsx("div", { style: { marginTop: 4 }, children: t("followPendingHint") }) : null,
					] }) : null,
