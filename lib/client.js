...
window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var zh = {
			...
			notEffective: "未生效 —— 上方「启用代理」总开关已关闭，代理不转发任何流量；开启总开关后此地址才生效。",
		...
		var en = {
			...
			notEffective: "Not effective — the master switch above is off, no traffic is forwarded. Turn it on to apply this address.",
			...
			return react_jsx_runtime.jsx("div", { className: "npx-root", children: [
				...
				tab === "log" ? react_jsx_runtime.jsx(LogPanel, { t: t }) : tab === "charts" ? react_jsx_runtime.jsx(ChartPanel, { t: t }) : react_jsx_runtime.jsx("section", { className: "npx-panel", children: [
					...
					following ? react_jsx_runtime.jsxs("div", { className: on ? "npx-alert ok" : "npx-alert err", children: [
						...
						!on ? react_jsx_runtime.jsx("div", { style: { marginTop: 4 }, children: t("notEffective") }) : null,
					] }) : null,
